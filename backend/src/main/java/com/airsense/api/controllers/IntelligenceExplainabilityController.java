...
public class IntelligenceExplainabilityController {
    private final DecisionIntelligenceService decisionIntelligenceService;
    private final ExplainabilityService explainabilityService;

    @GetMapping("/explainability")
    public ResponseEntity<ExplainabilityResult> getExplainability(
        ...
        DecisionIntelligenceResult decision = decisionIntelligenceService.decide(DecisionRequest.builder()
                .cityId(cityId)
                .placeId(placeId)
                .cityName(cityName)
                .state(state)
                ...
                .longitude(longitude)
                .build());
        return ResponseEntity.ok(explainabilityService.explain(decision));
    }
}
