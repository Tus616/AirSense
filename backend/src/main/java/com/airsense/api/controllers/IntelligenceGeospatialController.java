...
public class IntelligenceGeospatialController {
    private final GeoSpatialIntelligenceService geoSpatialIntelligenceService;

    @GetMapping("/geospatial")
    public ResponseEntity<GeoSpatialIntelligenceResult> getGeospatial(
        ...
        return ResponseEntity.ok(geoSpatialIntelligenceService.generate(GeoSpatialRequest.builder()
                .cityId(cityId)
                .placeId(placeId)
                .cityName(cityName)
                .state(state)
